...
void solve()
{
  ...
  */ 
    ...
    st.insert(mp(kx-a,ky-b));
    st.insert(mp(kx-a,ky+b));
    st.insert(mp(qx-a,qy-b));
    st.insert(mp(qx-a,qy+b));
    ...
    st.insert(mp(kx-b,ky-a));
    st.insert(mp(kx-b,ky+a));
    st.insert(mp(qx-b,qy-a));
    st.insert(mp(qx-b,qy+a));
    ...
    fr(st)
    {
        if((i.first-a == kx or i.first+a == kx) and ((i.second-b == ky or i.second+b == ky)) or (i.first-b == kx or i.first+b == kx) and ((i.second-a == ky or i.second+a == ky)))
        {
            if((i.first-a == qx or i.first+a == qx) and ((i.second-b == qy or i.second+b == qy)) or (i.first-b == qx or i.first+b == qx) and ((i.second-a == qy or i.second+a == qy)))
                ans++;
        }
        // if(((i.first-a == kx or i.first+a == kx) and (i.first-b == kx or i.first+b == kx) and (i.second-b == ky or i.second+b == ky) and (i.second-b == qy or i.second+b== qy)) or ((i.first-b == kx or i.first+b == kx) and (i.first-b == qx or i.first+b == qx) and (i.second-a == ky or i.second+a == ky) and (i.second-a == qy or i.second+a== qy)))
        //     ans++;
