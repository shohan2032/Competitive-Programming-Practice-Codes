...
*/
vs st;
void all_possible_substring()
{
    for(char ch = 'a';ch <= 'z';ch++)//for one size substring
    {
        string s;
        s += ch;
        st.pb(s);
    }
    for(char ch = 'a';ch <= 'z';ch++)//for two size substring
    {
        string s;
        s += ch;
        for(char c = 'a';c <= 'z';c++)
    ...
    for(char ch = 'a';ch <= 'z';ch++)//for three size substring
    {
        string s;
        s += ch;
        for(char c = 'a';c <= 'z';c++)
