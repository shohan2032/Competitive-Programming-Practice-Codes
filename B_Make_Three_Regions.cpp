...
void solve()
{
  ...
  */ 
    ...
    string s1,s2;
    cin >> n >> s1 >> s2;
    int pre1[n+5] = {},pre2[n+5] = {},suf1[n+5] = {},suf2[n+5] = {};
    int cnt1 = 0,cnt2 = 0;
    for(int i = 0;i < n;i++)
    {
        if(s1[i] == '.')
    ...
    for(int i = 0;i < n;i++)
    {
        if(i+2 < n)
        {
            if(s1[i] == 'x' and s1[i+2] == 'x' and s2[i+1] == '.' and s1[i+1] == '.' and (pre1[i] or pre2[i]) and (suf1[i+2] or suf2[i+2]))
            {
                // cout << 1 << " " << i << endl;
                ans++;
            }
            if(s1[i] == 'x' and s1[i+2] == '.' and s2[i+1] == 'x' and s1[i+1] == '.' and (pre1[i] or pre2[i]) and (suf1[i+2] or suf2[i+2]))
            {
                // cout << 1 << " " << i << endl;
                ans++;
            }
            if(s1[i] == '.' and s1[i+2] == 'x' and s2[i+1] == 'x' and s1[i+1] == '.' and (pre1[i] or pre2[i]) and (suf1[i+2] or suf2[i+2]))
            {
                // cout << 1 << " " << i << endl;
                ans++;
            }

            if(s2[i] == 'x' and s2[i+2] == 'x' and s1[i+1] == '.' and s2[i+1] == '.' and (pre1[i] or pre2[i]) and (suf1[i+2] or suf2[i+2]))
            {
                // cout << 2  << " " << i << endl;
                ans++;
            }
            if(s2[i] == 'x' and s2[i+2] == '.' and s1[i+1] == 'x' and s2[i+1] == '.' and (pre1[i] or pre2[i]) and (suf1[i+2] or suf2[i+2]))
            {
                // cout << 2  << " " << i << endl;
                ans++;
            }
            if(s2[i] == '.' and s2[i+2] == 'x' and s1[i+1] == 'x' and s2[i+1] == '.' and (pre1[i] or pre2[i]) and (suf1[i+2] or suf2[i+2]))
            {
                // cout << 2  << " " << i << endl;
                ans++;
            }
