...
void solve()
{
  ...
  */ 
    ...
    else
    {
        ...
        int nine_cnt = s/9;
        int r = s%9;
        int zero_cnt = n-(nine_cnt+(r!=0));
        while(nine_cnt--)max_ans.pb('9');
        while(r){max_ans.pb(intTochar(r));break;};
        while(zero_cnt--)max_ans.pb('0');
        
        nine_cnt = (s-1)/9;
        r = (s-1)%9;
        zero_cnt = n-(nine_cnt+(r != 0));
        while(nine_cnt--)min_ans.pb('9');
        while(r){min_ans.pb(intTochar(r));break;};
        while(zero_cnt--)min_ans.pb('0');
        reverse(all(min_ans));
        min_ans[0]++;
