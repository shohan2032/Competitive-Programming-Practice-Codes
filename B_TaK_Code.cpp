    ...
    for(int i =1;i <= n;i++)
    {
        for(int j = 1;j <= m;j++)
        {
            ...
            if(ch[i][j] == '#')
            {
                ...
                if(i+6 <= n and j+6 <= m)
                {
                    if(ch[i][j] != ch[i+6][j+6])
                        f = 0;
                }
                else
                    f = 0;
                if(i+1+6 <= n and j+6 <= m)
                {
                    if(ch[i+1][j] != ch[i+1+6][j+6])
                        f = 0;
                }
                else
                    f = 0;
                if(i+2+6 <= n and j+6 <= m)
                {
                    if(ch[i+2][j] != ch[i+2+6][j+6])
                        f = 0;
                }
                else
                    f = 0;
                if(i <= n and j+1+6 <= m)
                {
                    if(ch[i][j+1] != ch[i+6][j+1+6])
                        f = 0;
                }
                else
                    f = 0;
                if(i+1 <= n and j+1+6 <= m)
                {
                    if(ch[i][j+1] != ch[i+6][j+1+6])
                        f = 0;
                }
