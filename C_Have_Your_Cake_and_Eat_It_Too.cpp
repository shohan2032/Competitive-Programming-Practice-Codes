...
void solve()
{
  ...
  */ 
    ...
    fr(A)
    {
        if(i.first > 0 and i.second < n-1)
        {
            if(b[i.first-1] >= x and c[n-1]-c[i.second] >= x)
            {
                cout << i.first+1 << " " << i.second+1 << " " << 1 << " " << i.first << " " << i.second+2 << " " << n << endl;
                return;
            }
            else if(c[i.first-1] >= x and b[n-1]-b[i.second] >= x)
            {
                cout << i.first+1 << " " << i.second+1 << " " << i.second+2 << " " << n << " " << 1 <<  " " << i.first << endl;
                return;
            }
        }
    }
    fr(B)
    {
        if(i.first > 0 and i.second < n-1)
        {
            if(a[i.first-1] >= x and c[n-1]-c[i.second] >= x)
            {
                cout << 1 << " " << i.first << " " << i.first+1 << " " << i.second+1 << " " << i.second+2 << " " << n << endl;
                return;
            }
            else if(c[i.first-1] >= x and a[n-1]-a[i.second] >= x)
            {
                cout << i.second+2 << " " << n << " " << i.first+1 << " " << i.second+1 << " " << 1 << " " << i.first << endl;
                return;
            }
        }
    }
    fr(C)
    {
        if(i.first > 0 and i.second < n-1)
        {
            if(a[i.first-1] >= x and b[n-1]-b[i.second] >= x)
            {
                cout << 1 << " " << i.first << " " << i.second+2 << " " << n << " " << i.first+1 << " " << i.second+1 << endl;
                return;
            }
            else if(b[i.first-1] >= x and a[n-1]-a[i.second] >= x)
            {
                cout << i.second+2 << " " << n << " " << 1 << " " << i.first << " " << i.first+1 << " " << i.second+1 << endl;
                return;
            }
        }
    }
