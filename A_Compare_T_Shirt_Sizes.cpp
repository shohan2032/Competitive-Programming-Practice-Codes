...
void solve()
{
  ...
  */ 
    string a,b;
    cin>> a >> b;
    if(a.find('S') != string::npos and b.find('M') != string::npos)
        cout << '<' << endl;
    else if(a.find('M') != string::npos and b.find('S') != string::npos)
        cout << '>' << endl;
    else if(a.find('L') != string::npos and b.find('M') != string::npos)
        cout << '>' << endl;
    else if(a.find('M') != string::npos and b.find('L') != string::npos)
        cout << '<' << endl;
    else if(a.find('L') != string::npos and b.find('S') != string::npos)
        cout << '>' << endl;
    else if(a.find('S') != string::npos and b.find('L') != string::npos)
        cout << '<' << endl;
    else if(a.find('M') != string::npos and b.find('M') != string::npos)
        cout << '=' << endl;
    else if(a.find('S') != string::npos and b.find('S') != string::npos)
    {
        if(count(all(a),'X') > count(all(b),'X'))
            cout << '<' << endl;
        else if(count(all(a),'X') < count(all(b),'X'))
            cout << '>' << endl;
        else
            cout << '=' << endl;
    }
