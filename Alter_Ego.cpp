...
void solve()
{
  ...
  */ 
    ...
    int i = 1;
        while(!e.empty()){
            // cout << vc[i] << " " << e.front() << " " << e.back() << endl;
            int a = (e.front() + e.back())/2;
            int b = (e.front() - e.back())/2;
            ans[i] = a;
            ans[x+i] = b;
            e.pop_front();
            e.pop_back();
        ...
        while(!o.empty()){
            // cout << vc[i] << " " << o.front() << " " << o.back() << endl;
            int a = (o.front() + o.back())/2;
            int b = (o.front() - o.back())/2;
            ans[i] = a;
            ans[x+i] = b;
            o.pop_front();
            o.pop_back();
