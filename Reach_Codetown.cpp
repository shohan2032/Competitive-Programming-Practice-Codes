...
void solve()
{
  ...
  */ 
    ...
    if(v.find(s[3]) == string::npos)
    {
        cout << "NO" << endl;
        return;
    }
    if(v.find(s[5]) == string::npos)
    {
        cout << "NO" << endl;
        return;
    }
    ...
    if(v.find(s[2]) != string::npos)
    {
        cout << "NO" << endl;
        return;
    }
    if(v.find(s[4]) != string::npos)
    {
        cout << "NO" << endl;
        return;
    }
    if(v.find(s[6]) != string::npos)
    {
        cout << "NO" << endl;
        return;
    }
    if(v.find(s[7]) != string::npos)
    {
        cout << "NO" << endl;
        return;
    }
