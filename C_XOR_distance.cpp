...
void solve()
{
  ...
  */ 
    ...
    for(int i = 60;i >= 0;i--)
    {
        ...
        {
            if((b&(1ll<<i)) and x+(1ll<<i) <= r)//here ith bit of a is unset and ith bit of b is set. 
            {
                x += (1ll << i);
                a ^= (1ll << i);//toggling the ith bit of a,which will make a more bigger
                b ^= (1ll << i);//toggling the ith bit of b,whick will make b more smaller
            }
        }
    }
    cout << b-a << endl;
