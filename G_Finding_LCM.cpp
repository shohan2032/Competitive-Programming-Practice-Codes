...
//lcm(lcm(a,b),c) == L
//c = L/lcm(a,b);
//if c satisfy for L then (c*lcm(a,b))/gcd(c,lcm(a,b)) should be equal to L,in that case gcd(lcm(a,b),c) should be equal to 1,then (c*lcm(a,b)) will be equal to L;
int t = 1;
void solve()
{
    ll a,b,l;
...
/*Problem_link
    best tc for this problem --> 2 8 32
*/