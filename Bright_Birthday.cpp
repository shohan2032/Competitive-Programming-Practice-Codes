...
void solve()
{
  ...
  */ 
    ...
    cin >> s;
    map<char,int>mp;
    vector <string > vc = { "blue", "green", "yellow", "red", "purple", "orange", "pink", "grey", "cyan", "brown", "ash", "silver", "gold", "white", "black" };
...
/*Problem_link
    https://www.hackerrank.com/contests/srbd-code-contest-2023-round-1/challenges/bright-birthday/problem
*/