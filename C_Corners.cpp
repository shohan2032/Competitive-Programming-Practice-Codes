...
void solve()
{
   ...
   for(int i = 1;i < r;i++)
   {
        for(int j = 1;j < c;j++)
        {
            ...
            if(ch[i+1][j+1] == '1')cnt++;
            if(cnt != 0){
                if(ch[i][j] == '1' or ch[i][j+1] == '1' or ch[i+1][j] == '1')
                {
                    if(ch[i+1][j+1] == '1')//for |^^ 
                        ma = min(ma,cnt-1);
                    else
                ...
                if(ch[i][j] == '1' or ch[i][j+1] == '1' or ch[i+1][j+1] == '1')
                {
                    if(ch[i+1][j] == '1')//for ^^|
                        ma = min(ma,cnt-1);
                    else
                ...
                if(ch[i][j] == '1' or ch[i+1][j] == '1' or ch[i+1][j+1] == '1')
                {
                    if(ch[i][j+1] == '1')//for |__
                        ma = min(ma,cnt-1);
                    else
                        ma = min(ma,cnt);
                }
                if(ch[i][j+1] == '1' or ch[i+1][j] == '1' or ch[i+1][j+1] == '1')
                {
                    if(ch[i][j] == '1')//for __|
                        ma = min(ma,cnt-1);
                    else
